...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
	case WM_CREATE:
		MessageBox(hWnd, L"Create windows successfully", L"Create", MB_OK);
		break;

	/* LMB를 누르면, 새로운 창에 Hello World를 출력합니다. */
	case WM_LBUTTONDOWN:
	...
	/* 사용자가 윈도우를 종료하고자 할 때 종료할 것인지를 묻는 창을 띄웁니다. */
	case WM_CLOSE:
		BoxResult = MessageBox(hWnd, L"Should you exit this windows?", L"Exit", MB_OKCANCEL | MB_DEFBUTTON2);
		switch (BoxResult)
		{
		case IDOK:
			DestroyWindow(hWnd);
